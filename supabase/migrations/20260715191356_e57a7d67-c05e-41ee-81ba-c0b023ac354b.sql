GRANT SELECT ON public.admin_records TO anon, authenticated;
GRANT INSERT ON public.admin_records TO anon, authenticated;
GRANT ALL ON public.admin_records TO service_role;
