    ...
    <div className={cn("relative group", className)}>
      ...
      <div className="relative rounded-full bg-gradient-to-r from-[#6366f1] via-[#8b5cf6] to-[#22d3ee] p-[1.5px] shadow-[0_10px_30px_-15px_rgba(99,102,241,0.45)]">
        <form
          ...
          role="search"
          className={cn(
            "flex items-center gap-2 rounded-full bg-white/95 backdrop-blur-2xl pr-1.5 transition-colors",
            padLeft[size],
            heights[size],
          )}
        >
    ...
    <div className={cn("relative group", className)}>
      ...
      <div className="relative rounded-full bg-gradient-to-r from-[#6366f1] via-[#8b5cf6] to-[#22d3ee] p-[1.5px] shadow-[0_10px_30px_-15px_rgba(99,102,241,0.45)]">
        <button
          ...
          className={cn(
            "w-full flex items-center gap-2 rounded-full bg-white/95 backdrop-blur-2xl pr-1.5 text-left transition-colors hover:bg-white",
            padLeft[size],
            heights[size],
          )}
        >
