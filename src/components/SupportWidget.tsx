          ...
          >
            ...
            {!open && !chooser && (
              <>
                ...
                <span className="absolute inset-0 rounded-full bg-primary/40 animate-ping [animation-delay:0.6s]" />
              </>
            )}

            {/* Soft ambient glow */}
            <span className="support-widget-glow absolute -inset-4 rounded-full bg-primary/30 opacity-60 blur-2xl group-hover:opacity-90 transition-opacity duration-500" />

            {/* Main orb */}
            <span className="support-widget-orb relative grid place-items-center h-16 w-16 rounded-full bg-primary text-primary-foreground shadow-[0_22px_50px_-14px_rgba(0,0,0,0.25)] ring-1 ring-black/5 overflow-hidden">
