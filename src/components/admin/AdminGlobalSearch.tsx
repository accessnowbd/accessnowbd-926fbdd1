...
export function AdminGlobalSearch({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="admin-search-dialog p-0 gap-0 max-w-2xl bg-white border-slate-200 overflow-hidden rounded-2xl shadow-[0_30px_80px_-20px_rgba(15,23,42,0.3)]">
