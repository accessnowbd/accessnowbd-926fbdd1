      ...
      <div className="relative z-10 mx-auto max-w-[1440px] px-4 pb-7 pt-10 md:px-10 md:pt-12">
        ...
        <div className="mt-6 flex flex-col gap-4 rounded-[24px] border border-[var(--glass-border-soft)] bg-foreground/[0.04] px-4 py-4 lg:grid lg:grid-cols-[1fr_auto] lg:items-center lg:gap-4 lg:px-5">
          <div className="flex flex-col items-center gap-4 sm:flex-row sm:flex-wrap sm:items-center sm:justify-center lg:justify-start">
            ...
            <div className="relative inline-flex w-full max-w-full items-center justify-center rounded-2xl sm:rounded-full border border-[var(--glass-border)] bg-gradient-to-r from-primary/[0.08] via-aqua/[0.06] to-[var(--gold)]/[0.08] px-3 sm:px-4 py-2 sm:py-1.5 shadow-[0_4px_18px_-10px_rgba(79,70,229,0.35)] sm:w-auto sm:overflow-x-auto [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
              ...
              <p className="relative text-center sm:text-left text-[11px] sm:text-[12px] md:text-[12.5px] leading-5 sm:leading-6 tracking-[0.01em] whitespace-normal sm:whitespace-nowrap break-words">
