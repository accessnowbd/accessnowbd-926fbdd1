            ...
            <div className="flex flex-wrap items-center justify-between gap-3 mb-5">
              ...
              <label className="relative inline-flex items-center">
                <select
                  ...
                  className="appearance-none rounded-full border border-[var(--glass-border)] bg-background/80 backdrop-blur px-4 pr-9 py-2 text-xs font-semibold text-foreground focus:outline-none focus:ring-2 focus:ring-primary/40"
                >
                ...
                <ChevronDown className="w-3.5 h-3.5 pointer-events-none absolute right-3 top-1/2 -translate-y-1/2 text-foreground/60" />
              </label>
            </div>
