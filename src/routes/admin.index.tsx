...
function AdminDashboard() {
 ...
 <div className="flex items-center gap-3">
 <div className="w-11 h-11 rounded-2xl bg-white/70 backdrop-blur-md ring-1 ring-slate-200 text-white grid place-items-center shadow-md">
 ...
 <div className="w-8 h-8 rounded-lg bg-white/70 backdrop-blur-md ring-1 ring-slate-200 text-white grid place-items-center"><Star className="w-4 h-4" /></div>
 <div>
 ...
 <div className="flex items-center gap-2">
 <div className="w-9 h-9 rounded-xl bg-white/70 backdrop-blur-md ring-1 ring-slate-200 text-white grid place-items-center shadow-md">
 ...
 <div className="w-9 h-9 rounded-full bg-white/70 backdrop-blur-md ring-1 ring-slate-200 text-white grid place-items-center text-[11px] font-bold shrink-0">
 ...
 <div className="flex items-center justify-between mb-4">
 <div className="flex items-center gap-2">
 <div className="w-8 h-8 rounded-lg bg-white/70 backdrop-blur-md ring-1 ring-slate-200 text-white grid place-items-center"><LifeBuoy className="w-4 h-4" /></div>
 <div>
 ...
 <div className="flex items-center justify-between mb-4">
 <div className="flex items-center gap-2">
 <div className="w-8 h-8 rounded-lg bg-white/70 backdrop-blur-md ring-1 ring-slate-200 text-white grid place-items-center relative">
 ...
 <div className="flex items-center justify-between mb-4">
 <div className="flex items-center gap-2">
 <div className="w-8 h-8 rounded-lg bg-white/70 backdrop-blur-md ring-1 ring-slate-200 text-white grid place-items-center"><Monitor className="w-4 h-4" /></div>
 <div>
 ...
 <div className="flex items-center justify-between mb-4">
 <div className="flex items-center gap-2">
 <div className="w-8 h-8 rounded-lg bg-white/70 backdrop-blur-md ring-1 ring-slate-200 text-white grid place-items-center"><ShoppingBag className="w-4 h-4" /></div>
 ...
 <div className="flex items-center justify-between mb-4">
 <div className="flex items-center gap-2">
 <div className="w-8 h-8 rounded-lg bg-white/70 backdrop-blur-md ring-1 ring-slate-200 text-white grid place-items-center"><Box className="w-4 h-4" /></div>
 <div>
 ...
 <div className="w-10 h-10 rounded-xl bg-white/70 backdrop-blur-md ring-1 ring-slate-200 text-white grid place-items-center shadow"><Box className="w-5 h-5" /></div>
 <div>
