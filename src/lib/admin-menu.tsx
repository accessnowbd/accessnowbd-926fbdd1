...
export const ADMIN_MENU: AdminMenuGroup[] = [
  {
    ...
    icon: ic(Package),
    items: [
      { to: "/admin", label: "Dashboard", labelBn: "ড্যাশবোর্ড", icon: ic(LayoutDashboard), grad: "from-sky-500 to-blue-500", exact: true },
      { to: "/admin/products", label: "All Products", labelBn: "সব প্রোডাক্ট", icon: ic(Package), grad: "from-sky-500 to-cyan-500" },
      ...
      { to: "/admin/categories", label: "Categories", labelBn: "ক্যাটাগরি", icon: ic(FolderTree), grad: "from-slate-700 to-slate-900" },
      { to: "/admin/banner-slider", label: "Banner Slider", labelBn: "ব্যানার স্লাইডার", icon: ic(ImageIcon), grad: "from-cyan-500 to-pink-500" },
      ...
      { to: "/admin/media-gallery", label: "Media Gallery", labelBn: "মিডিয়া গ্যালারি", icon: ic(Images), grad: "from-blue-500 to-blue-600" },
      { to: "/admin/homepage-editor", label: "Homepage Editor", labelBn: "হোমপেজ এডিটর", icon: ic(Home), grad: "from-orange-400 to-amber-500" },
      { to: "/admin/footer-editor", label: "Footer Editor", labelBn: "ফুটার এডিটর", icon: ic(PanelBottom), grad: "from-slate-600 to-slate-800" },
    ],
  },
  {
    id: "orders",
  ...
  },
  {
    ...
    items: [
      ...
      { to: "/admin/referral", label: "Referral", labelBn: "রেফারেল", icon: ic(Gift), grad: "from-pink-500 to-cyan-500" },
      { to: "/admin/affiliates", label: "Affiliates", labelBn: "অ্যাফিলিয়েট", icon: ic(Share2), grad: "from-sky-500 to-blue-600" },
      ...
      { to: "/admin/fb-pixel", label: "FB Pixel & CAPI", labelBn: "এফবি পিক্সেল ও CAPI", icon: ic(BarChart3), grad: "from-blue-600 to-blue-700" },
  ...
  },
  {
    ...
    items: [
      ...
      { to: "/admin/support-widget", label: "Support Widget", labelBn: "সাপোর্ট উইজেট", icon: ic(MessageCircle), grad: "from-sky-500 to-cyan-600" },
    ],
  },
  {
    id: "content",
    ...
    items: [
      ...
      { to: "/admin/description-template", label: "Description Template", labelBn: "ডেসক্রিপশন টেমপ্লেট", icon: ic(FileEdit), grad: "from-sky-500 to-cyan-500" },
      { to: "/admin/description-preview", label: "Description Preview", labelBn: "ডেসক্রিপশন প্রিভিউ", icon: ic(FileEdit), grad: "from-cyan-500 to-pink-500" },
  ...
  },
  {
    ...
    icon: ic(Settings),
    items: [
      { to: "/admin/analytics", label: "Analytics Dashboard", labelBn: "অ্যানালিটিক্স ড্যাশবোর্ড", icon: ic(PieChart), grad: "from-sky-500 to-blue-600" },
      ...
      { to: "/admin/reports", label: "Reports", labelBn: "রিপোর্ট", icon: ic(BarChart3), grad: "from-blue-500 to-blue-600" },
      { to: "/admin/ai-api", label: "AI API Settings", labelBn: "AI API সেটিংস", icon: ic(Bot), grad: "from-sky-500 to-cyan-500" },
      { to: "/admin/settings", label: "Settings", labelBn: "সেটিংস", icon: ic(Settings), grad: "from-slate-600 to-slate-800" },
      { to: "/admin/themes", label: "Themes", labelBn: "থিম", icon: ic(Sparkles), grad: "from-sky-500 to-cyan-500" },
      ...
      { to: "/admin/ai-command", label: "AI Command Center", labelBn: "AI কমান্ড সেন্টার", icon: ic(Sparkles), grad: "from-sky-500 to-cyan-500" },
    ],
  },
];
