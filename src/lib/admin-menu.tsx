...
export const ADMIN_MENU: AdminMenuGroup[] = [
  {
    ...
    icon: ic(Package),
    items: [
      { to: "/admin", label: "Dashboard", labelBn: "ড্যাশবোর্ড", icon: ic(LayoutDashboard), grad: "from-violet-500 to-purple-600", exact: true },
      { to: "/admin/products", label: "All Products", labelBn: "সব প্রোডাক্ট", icon: ic(Package), grad: "from-indigo-500 to-pink-500" },
      ...
      { to: "/admin/banner-slider", label: "Banner Slider", labelBn: "ব্যানার স্লাইডার", icon: ic(ImageIcon), grad: "from-rose-500 to-pink-600" },
