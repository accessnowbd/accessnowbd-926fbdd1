...
export const ADMIN_MENU: AdminMenuGroup[] = [
  {
    ...
    icon: ic(Package),
    items: [
      { to: "/admin", label: "Dashboard", labelBn: "ড্যাশবোর্ড", icon: ic(LayoutDashboard), grad: "from-slate-700 to-slate-900", exact: true },
      { to: "/admin/products", label: "All Products", labelBn: "সব প্রোডাক্ট", icon: ic(Package), grad: "from-slate-600 to-slate-800" },
      ...
      { to: "/admin/banner-slider", label: "Banner Slider", labelBn: "ব্যানার স্লাইডার", icon: ic(ImageIcon), grad: "from-sky-500 to-blue-600" },
      { to: "/admin/welcome-popup", label: "Welcome Popup", labelBn: "ওয়েলকাম পপআপ", icon: ic(PartyPopper), grad: "from-rose-500 to-red-500" },
      ...
      { to: "/admin/media-gallery", label: "Media Gallery", labelBn: "মিডিয়া গ্যালারি", icon: ic(Images), grad: "from-blue-500 to-cyan-600" },
  ...
  },
  {
    ...
    icon: ic(Sparkles),
    items: [
      { to: "/admin/coupons", label: "Coupons", labelBn: "কুপন", icon: ic(TicketPercent), grad: "from-rose-500 to-red-500" },
      { to: "/admin/referral", label: "Referral", labelBn: "রেফারেল", icon: ic(Gift), grad: "from-amber-500 to-orange-500" },
      { to: "/admin/affiliates", label: "Affiliates", labelBn: "অ্যাফিলিয়েট", icon: ic(Share2), grad: "from-slate-600 to-slate-800" },
      ...
      { to: "/admin/fb-pixel", label: "FB Pixel & CAPI", labelBn: "এফবি পিক্সেল ও CAPI", icon: ic(BarChart3), grad: "from-blue-600 to-sky-700" },
  ...
  },
  {
    ...
    icon: ic(Settings),
    items: [
      { to: "/admin/analytics", label: "Analytics Dashboard", labelBn: "অ্যানালিটিক্স ড্যাশবোর্ড", icon: ic(PieChart), grad: "from-slate-600 to-slate-800" },
      ...
      { to: "/admin/reports", label: "Reports", labelBn: "রিপোর্ট", icon: ic(BarChart3), grad: "from-blue-500 to-cyan-600" },
      { to: "/admin/ai-api", label: "AI API Settings", labelBn: "AI API সেটিংস", icon: ic(Bot), grad: "from-slate-600 to-slate-800" },
      ...
      { to: "/admin/ai-command", label: "AI Command Center", labelBn: "AI কমান্ড সেন্টার", icon: ic(Sparkles), grad: "from-slate-600 to-slate-800" },
    ],
  },
];
