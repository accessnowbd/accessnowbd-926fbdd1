...
export const ADMIN_MENU: AdminMenuGroup[] = [
  {
    ...
    items: [
      ...
      { to: "/admin/products", label: "All Products", labelBn: "সব প্রোডাক্ট", icon: ic(Package), grad: "from-violet-500 to-purple-600" },
      ...
      { to: "/admin/welcome-popup", label: "Welcome Popup", labelBn: "ওয়েলকাম পপআপ", icon: ic(PartyPopper), grad: "from-pink-500 to-fuchsia-500" },
      ...
      { to: "/admin/homepage-editor", label: "Homepage Editor", labelBn: "হোমপেজ এডিটর", icon: ic(Home), grad: "from-indigo-500 to-blue-600" },
  ...
  },
  {
    ...
    items: [
      ...
      { to: "/admin/wallet", label: "Wallet", labelBn: "ওয়ালেট", icon: ic(Wallet), grad: "from-violet-500 to-purple-600" },
  ...
  },
  {
    ...
    icon: ic(Sparkles),
    items: [
      { to: "/admin/coupons", label: "Coupons", labelBn: "কুপন", icon: ic(TicketPercent), grad: "from-pink-500 to-fuchsia-500" },
      { to: "/admin/referral", label: "Referral", labelBn: "রেফারেল", icon: ic(Gift), grad: "from-pink-500 to-rose-500" },
  ...
  },
  {
    ...
    icon: ic(Settings),
    items: [
      { to: "/admin/analytics", label: "Analytics Dashboard", labelBn: "অ্যানালিটিক্স ড্যাশবোর্ড", icon: ic(PieChart), grad: "from-violet-500 to-purple-600" },
      ...
      { to: "/admin/ai-api", label: "AI API Settings", labelBn: "AI API সেটিংস", icon: ic(Bot), grad: "from-violet-500 to-purple-600" },
      ...
      { to: "/admin/ai-command", label: "AI Command Center", labelBn: "AI কমান্ড সেন্টার", icon: ic(Sparkles), grad: "from-violet-500 to-fuchsia-600" },
    ],
  },
];
