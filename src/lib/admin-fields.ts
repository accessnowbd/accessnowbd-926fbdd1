...
const FEATURES: Record<string, AdminFeatureConfig> = {
  "banner-slider": {
    ...
    fields: [
      ...
      { name: "color_preset", label: "Readymade color", type: "select", options: [
        { value: "ruby", label: "Ruby background + Gold pop" },
        { value: "ocean", label: "Ocean background + Orange pop" },
        { value: "violet", label: "Violet background + Mint pop" },
        { value: "emerald", label: "Emerald background + Pink pop" },
        { value: "graphite", label: "Graphite background + Sky pop" },
        { value: "indigo", label: "Indigo background + Yellow pop" },
      ] },
